...
// NEED TO MAKE LINK BE THE TEXT FROM THE LI NOT PRE PUT IN TO GET BOTH TO WORK AND TO HAVE NICE URL'S WHEN DONE DO ON MAIN TABS TOO
...
(function() {
  ...
  var tabWidget = [].slice.call(document.querySelectorAll('.js-tabs-demo, .js-tabs-demo--five')) || [];
